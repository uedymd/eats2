...
class CreateDigimartItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('digimart_items', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('digimart_id');
    ...
    {
        Schema::dropIfExists('digimart_items');
    }
}
