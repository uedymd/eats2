...
class CreateKurosawaItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kurosawa_items', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('kurosawa_id');
    ...
    {
        Schema::dropIfExists('kurosawa_items');
    }
}
