<nav id="globalnavi" x-data="{ open: false }" class="bg-white border-b border-gray-100 z-10">
            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <!-- Account Management -->
                            <x-jet-responsive-nav-link href="{{ route('rakuten.index') }}" :active="request()->routeIs('api-tokens.index')">
                                楽天管理
                            </x-jet-responsive-nav-link>
                            <x-jet-responsive-nav-link href="{{ route('digimart.index') }}" :active="request()->routeIs('api-tokens.index')">
                                デジマート管理
                            </x-jet-responsive-nav-link>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-responsive-nav-link href="{{ route('setting.rate.edit') }}" :active="request()->routeIs('api-tokens.index')">
                                ドル円レート設定
                            </x-jet-responsive-nav-link>
                            <div class="border-t border-gray-100"></div>
