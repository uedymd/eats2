                    ...
                    <form method="POST" action="{{ route('digimart.update',['id'=>$digimart->id]) }}">
                        ...
                        <div class="mt-4 flex">
                            <div class="flex-shrink-0 w-8/12">
                                ...
                                <x-input id="keyword" class="block mt-1 w-full" type="text" name="keyword" :value="old('keyword',$digimart->keyword)" required autofocus />
                            </div>
                        ...
                        <div class="mt-4">
                            <div class="flex-shrink-0 w-8/12">
                                ...
                                <x-input id="genre" class="block mt-1 w-full" type="text" name="genre" :value="old('genre',$digimart->genre)" autofocus />
                                <x-input id="genre_id" type="hidden" name="genre_id" :value="old('genre_id',$digimart->genre_id)" />
                            </div>
                            <div class="block digimart__genre--button">
                                <ul class="digimart__genre--selector">
                                    <li class="digimart__genre--parent hasChild" data-genre="0"><span class="block p-3 mt-5 rounded bg-blue-200 text-center w-2/12">ジャンルを選択</span></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 flex">
                            <div class="flex-1">
                                ...
                                <x-input id="price_min" class="mt-1 w-10/12" type="number" name="price_min" :value="old('price_min',$digimart->price_min)" autofocus />円
                            </div>
                            <div class="flex-1">
                                <x-label for="price_max" :value="__('最大価格')" />

                                <x-input id="price_max" class="mt-1 w-10/12" type="number" name="price_max" :value="old('price_max',$digimart->price_max)" autofocus />円
                            </div>
                            <div class="flex-1">
